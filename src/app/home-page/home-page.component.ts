...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MenuComponent, FooterComponent, HeroComponent, ResumeComponent, TransitionComponent, HighschoolComponent, IutComponent, CountactComponent, ScuComponent, ProjectsComponent, WorkwithmeComponent],
  templateUrl: './home-page.component.html',
  styleUrl: './home-page.component.css'
})
export class HomePageComponent {
  //TODO: Snap scroller script; working but put on hold
  // ngOnInit(): void {
